"""
Supplementary Fig. 4  Bridge-versus-averaged partition stability on EmoBank.
a: ARI between per-bridge and averaged k-means partitions, plotted vs k.
b: Template radius per material.
Uses the frozen base-raw_logp cube (12 affect anchors, 3 fixed bridges, dev set).
...
# Frozen cube (same data path as the EmoBank sensitivity analysis)
CUBE_PATH = ROOT / "runs/e3-emobank-final-analysis-47430/base-raw_logp.npz"
...
def main():
    ...
    ncstyle.save(fig, "sfig4-template-english", FIGDIR)
    print("Supplementary Fig. 4 saved.")
