...
def admit_vision_reuse(summary: Path) -> dict:
    ...
    source = summary.parent.parent / "source/src/vlanchor/backends/vision_reuse.py"
    current = Path(__file__).resolve().parents[1] / "src/vlanchor/backends/vision_reuse.py"
